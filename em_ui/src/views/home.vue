<template>
  <a-layout class="content">
    ...
    <a-layout-footer>Copyright © 2023 兔兔物业管理系统</a-layout-footer>
  </a-layout>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      login_form_data: {},
      carousel_img_list: ['https://s3.ax1x.com/2021/03/13/6dz6HS.png', 'http://img4.imgtn.bdimg.com/it/u=290215386,829228996&fm=15&gp=0.jpg'],
      tabListNoTitle: [
        {
          key: 'em_notice',
          tab: '物业公告',

<template>
  <div>
    <page-header title="欢迎使用「兔兔物业管理系统」">
      <template #content>
        <div>
        </div>
      </template>
      <el-button-group style="margin-right: 10px;">
        <el-button
          type="success"
          plain
          @click="open('https://gitee.com/KQYLove')"
        >代码仓库</el-button>
        <el-button type="primary" plain @click="open('https://wen-blog.cn/')">个人博客</el-button>
      </el-button-group>
    </page-header>
    <page-main>
      ...
      <el-row :gutter="24" v-show="isAdmin">
        ...
        <el-col :span="6" :offset="0">
          <Card title num="业主管理" tip="小区内业主账号的管理" type="blue" icon="el-icon-user" />
        </el-col>
        <el-col :span="6" :offset="0">
          <Card title num="费用管理" tip="小区内业主的费用管理" type="blue" icon="el-icon-coin" />
        </el-col>
      </el-row>
      <el-row :gutter="24" v-show="isAdmin">
        <el-col :span="6" :offset="0">
